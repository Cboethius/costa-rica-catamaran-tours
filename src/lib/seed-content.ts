...
export const defaultSiteContent: SiteContent = {
  ...
  faq: [
    ...
    },
    {
      ...
      answer:
        "Morning cruises offer calm seas, cooler temperatures, and return around midday, which is great if you want the rest of the day free. Sunset cruises are our most popular option: afternoon sailing, snorkeling in a bay, and watching the Pacific sunset from the deck. Both include food, drinks, and water activities.",
    },
    {
    ...
    },
    {
      ...
      answer:
        "Yes. We arrange Discover Spearfishing intro sessions, Spearo courses, reef trips (Catalina Islands, Potrero Bay), and blue water offshore trips along the Gold Coast. Minimum age is 18 and a Costa Rican fishing license (INCOPESCA) is required. See the Freediving or Spearfishing tour Details page for requirements, or inquire through our booking form and we will confirm availability.",
    },
    {
    ...
    },
    {
      ...
      answer:
        "Yes. Every tour on our homepage has a Details link with the full overview, duration and schedule, step-by-step day itinerary, what's included, and what to bring, all specific to that tour.",
    },
  ],
  testimonials: [
    {
