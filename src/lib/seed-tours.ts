...
const audienceTakeaway = "Perfect for couples, families, and solo travelers";
...
export const defaultTours: Tour[] = [
  ...
  withDetails({
    ...
    description:
      "The ultimate Gold Coast experience. A full day on the water with extended sailing, multiple swim stops, snorkeling, paddleboarding, a full meal and open bar. Perfect for couples, families, and solo travelers who want to soak up every moment of Costa Rica's Pacific paradise.",
    longDescription:
